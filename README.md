---
description: OSDeploy is a PowerShell-driven OS deployment platform for Windows. Build WinPE boot images on Windows 11, deploy Windows 11 from the cloud in WinPE, and manage the full deployment lifecycle — all from PowerShell.
---
...
- [**Inside WinPE**](inside-winpe/winpe-startup/README.md) — WinPE startup sequence, boot environments, and troubleshooting
