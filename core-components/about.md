...
| 7-Zip                        | Archive tool for extracting driver packs; injected into WinPE as a utility | Optional              | `Install-OSDeploySoftware` |
...
* [PowerShell](powershell/) — Learn why OSDeploy requires PowerShell 7.6 or later
* [PowerShell Modules](../command-reference/about.md) — Install the OSDeploy, OSDCloud, and OSD modules from the PowerShell Gallery
...
* [Windows 11](../osdeploy-guide/initial-setup/operating-system/windows-11-os.md) — Configure Windows and optional features such as Hyper-V
