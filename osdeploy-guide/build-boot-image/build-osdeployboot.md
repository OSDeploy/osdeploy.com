---
description: Configure and build customized OSDeploy WinPE media from an imported WinRE image or the Windows ADK WinPE image.
---
...
* [OSDeploy module](../module-setup/README.md)
* [OSDeploy Core](../osdeploy-core/README.md)
* [Windows ADK and WinPE add-on](../../core-components/microsoft-windows-adk/README.md)
...
See [Build a Boot Image](README.md) for the workflow overview or the [Build-OSDeployBoot command reference](../../command-reference/osdeploy/build-osdeployboot.md) for compact syntax and parameter definitions.
