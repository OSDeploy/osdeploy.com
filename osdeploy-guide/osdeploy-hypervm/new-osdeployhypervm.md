...
See [Create a Hyper-V VM](./) for the basic workflow or the [New-OSDeployHyperVM command reference](../../command-reference/osdeploy/new-osdeployhypervm.md) for compact syntax and parameter definitions.
