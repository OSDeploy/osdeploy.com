...
See [Module Setup](./) for the installation workflow or the [Get-OSDeployModuleVersion command reference](../../../command-reference/osdeploy/get-osdeploymoduleversion.md) for compact syntax and output information.
