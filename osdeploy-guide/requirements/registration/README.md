...
The OSDeploy PC is now registered. Continue to [Install Software](../../basic/software.md), or continue without registration using the features available for unregistered use.
