...
See [Module Setup](../requirements/powershell-modules.md) for the installation workflow or the [Get-OSDeployModulePath command reference](../../command-reference/osdeploy/get-osdeploymodulepath.md) for compact syntax and output information.
