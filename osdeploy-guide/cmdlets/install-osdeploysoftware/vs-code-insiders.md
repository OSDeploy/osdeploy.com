...
Open the OSDeploy repository or scripts in Visual Studio Code Insiders. See the [Visual Studio Code reference](../../../core-components/developer-tools/vscode.md) for related editor setup.
