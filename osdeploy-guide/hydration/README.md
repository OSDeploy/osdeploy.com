---
description: Prepare an OSDeploy workstation and create Hydra boot media with Invoke-OSDeployHydration.
icon: play
---

# Hydrate an OSDeploy Workstation
...
For `-Force`, `-WhatIf`, workflow details, and returned objects, see [Invoke-OSDeployHydration](invoke-osdeployhydration.md). For compact syntax and parameter definitions, see the [Invoke-OSDeployHydration command reference](../../command-reference/osdeploy/invoke-osdeployhydration.md).
