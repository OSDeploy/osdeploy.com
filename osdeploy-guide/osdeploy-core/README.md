...
Use the guides in this section to [install required software](../install-osdeploysoftware/), [prepare Windows 11 content](update-osdeploycore/update-windows-11-os/), and [maintain WinPE drivers](update-osdeploycore/update-winpe-drivers/) before creating a boot image.
