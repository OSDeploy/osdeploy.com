...
* [Windows ADK 25H2](../advanced-usage/install-osdeploysoftware/windows-adk-25h2.md)
* [Windows ADK 26H1](../advanced-usage/install-osdeploysoftware/windows-adk-26h1.md)
* [Microsoft Deployment Toolkit](../advanced-usage/install-osdeploysoftware/microsoft-mdt.md)
* [Git for Windows](../advanced-usage/install-osdeploysoftware/git-for-windows.md)
* [Visual Studio Code](../advanced-usage/install-osdeploysoftware/vs-code-stable.md)
* [Visual Studio Code Insiders](../advanced-usage/install-osdeploysoftware/vs-code-insiders.md)
* [Microsoft Hyper-V](../advanced-usage/install-osdeploysoftware/microsoft-hyper-v.md)
* [7-Zip](../advanced-usage/install-osdeploysoftware/7-zip.md)
