...
For installation and download behavior, see [Windows ADK 25H2](../advanced-usage/install-osdeploysoftware/windows-adk-25h2.md) and [7-Zip](../advanced-usage/install-osdeploysoftware/7-zip.md).
