---
description: Return, compare, and format the version of the currently loaded OSDeploy module.
---
...
Install OSDeploy and run the command from PowerShell 7.6 or later. See [Module Setup](README.md) for installation and import instructions.
...
See [Module Setup](README.md) for the installation workflow or the [Get-OSDeployModuleVersion command reference](../../command-reference/osdeploy/get-osdeploymoduleversion.md) for compact syntax and output information.
