...
See [Module Setup](README.md) for the installation workflow or the [Get-OSDeployModulePath command reference](../../command-reference/osdeploy/get-osdeploymodulepath.md) for compact syntax and output information.
