...
See [Module Setup](../requirements/powershell-modules/) to install OSDeploy and [OSDeploy Boot](../basic/osdeploy-boot.md) to create completed boot media.
...
See [Create an OSDCloud USB](../basic/osdeploy-usb.md) for the workflow overview or the [Update-OSDeployBootUSB command reference](../../command-reference/osdeploy/update-osdeploybootusb.md) for compact syntax and parameter definitions.
