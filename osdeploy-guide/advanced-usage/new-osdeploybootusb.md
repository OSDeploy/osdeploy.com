...
See [Create an OSDCloud USB](../basic/osdeploy-usb.md) for the workflow overview or the [New-OSDeployBootUSB command reference](../../command-reference/osdeploy/new-osdeploybootusb.md) for compact syntax and parameter definitions.
