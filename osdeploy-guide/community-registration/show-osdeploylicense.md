---
description: Discover, inspect, and validate the Recast Software license candidate selected for OSDeploy.
---
...
Run the function from PowerShell 7.6 or later on Windows with the current [OSDeploy module](../module-setup/README.md) installed.
...
See [Community Registration](README.md) to download and install a free Recast Software Community License.
...
See [Community Registration](README.md) to download, install, and verify a Community License.
