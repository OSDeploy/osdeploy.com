...
The OSDeploy PC is now registered. Continue to [Install Software](../install-osdeploysoftware/), or continue without registration using the features available for unregistered use.
