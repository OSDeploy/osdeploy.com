...
3. Install the required [PowerShell modules](../module-setup/).
4. Optionally complete [Community Registration](../community-registration/).
5. Install any additional [OSDeploy software](../install-osdeploysoftware/) required by your workflow.
