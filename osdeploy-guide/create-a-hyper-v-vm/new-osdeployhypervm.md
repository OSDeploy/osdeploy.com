...
See [Module Setup](../module-setup/README.md) to install OSDeploy and [Microsoft Hyper-V](../install-osdeploysoftware/microsoft-hyper-v.md) to enable Hyper-V.
...
See [Create a Hyper-V VM](README.md) for the basic workflow or the [New-OSDeployHyperVM command reference](../../command-reference/osdeploy/new-osdeployhypervm.md) for compact syntax and parameter definitions.
