# WinSE - Setup Environment (boot.wim)
...
YYYY-MM-DD HH:mm:ss.SSS, Info    Succeeded launching application (null) [command line: X:\setup.exe]
```
{% endstep %}
...
{% file src="../../.gitbook/assets/content-WinSxS (2).txt" %}
WinSxS removed
{% endfile %}

{% file src="../../.gitbook/assets/content (2).txt" %}
