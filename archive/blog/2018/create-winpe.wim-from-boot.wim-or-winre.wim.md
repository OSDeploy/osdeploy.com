...
Obviously you can also do the same process using [OSBuilder's PEBuild](/broken/pages/-LOqAvfXF9ybmyY97mVh), but its easy enough to create a WinPE.wim using this script.

## New-WinPE.ps1

Download the complete PowerShell Script.  Admin Rights (Elevated) are required since you are going to be working with DISM

{% file src="../../../.gitbook/assets/New-WinPE.ps1" %}
New-WinPE.ps1
{% endfile %}
