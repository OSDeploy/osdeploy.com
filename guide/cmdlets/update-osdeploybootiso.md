...
See [The OSDeploy Boot ISO](../../archive/update-osdeploybootiso.md) for the related workflow or the [Update-OSDeployBootISO command reference](../../command-reference/osdeploy/update-osdeploybootiso.md) for compact syntax.
